          ...
          orders.map((pedido,key) => (
            ...
            <View style={styles.viewRow}>
              ...
              <Text style={styles.textoAzul}> {pedido.status} </Text>
              {
                ...
                <View>
                <TouchableOpacity style={styles.viewRemover} onPress={()=>{
                  cancelaPedidos(pedido.id)
                  getPedidos()}}>
                  <Text style={styles.Remover}>Cancelar</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.viewFinalizar} onPress={()=>{
                  finalizaPedido(pedido.id)
                  getPedidos()}
                  }>
              ...
              <View style={styles.viewRemoverOculto}>
                <Text style={styles.RemoverOculto}>{pedido.status}</Text>
              </View>
              }
